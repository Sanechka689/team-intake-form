...
const fieldItems: Array<{ name: keyof IntakeFormData; title: string; hint: string; rows?: number }> = [
  ...
  },
  {
    ...
    title: 'Инструменты',
    hint: 'Перечислите инструменты, которыми реально пользуетесь в работе.',
    rows: 3
  },
  {
    name: 'roles_to_try',
    title: 'Что готов(а) делать',
    hint: 'Какие задачи вы готовы брать сразу на практике.',
    rows: 4
  },
  {
    name: 'dont_want',
    title: 'Что НЕ хочу делать',
  ...
  },
  {
    name: 'constraints',
    title: 'Желаемая роль',
    hint: 'Какую роль в проекте вы хотите занять в первую очередь.',
    rows: 3
  },
  {
    name: 'goal',
    title: 'Ожидания от проекта',
  ...
  {
    name: 'questions',
    title: 'Примеры работ / портфолио (если есть)',
    hint: 'Ссылка на работы или короткое описание релевантного опыта.',
    rows: 3
  },
  {
    name: 'comment',
